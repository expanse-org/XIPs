...
eip author: Alex Beregszaszi (@axic)
type: Meta
status: Final
created: 2017-04-23
...
- Activation:
  - Block >= 800,000 on Mainnet
  - Block >= 0 on Aegis testnet
- XIP Changes
  - Block reward lowered to 4 EXP
  - Block durationLimit (block target) lowered to 30 seconds
- Included EIPs:
